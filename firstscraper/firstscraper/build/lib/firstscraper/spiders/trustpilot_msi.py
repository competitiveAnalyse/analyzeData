...
class TrustpilotMsiSpider(scrapy.Spider):
    name = 'trustpilot_msi'
    allowed_domains = ['trustpilot.com/review/us.msi.com?languages=en']
    start_urls = ['https://www.trustpilot.com/review/us.msi.com?languages=en']
    custom_settings = {
        'FEED_FORMAT':'json',
        'FEED_URI':'/home/juan/trustpilot_msi.json',
