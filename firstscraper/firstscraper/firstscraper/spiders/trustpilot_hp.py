...
class TrustpilotMsiSpider(scrapy.Spider):
    name = 'trustpilot_hp'
    allowed_domains = ['trustpilot.com/review/hp.com?languages=en']
    start_urls = ['https://www.trustpilot.com/review/hp.com?languages=en']
    custom_settings = {
        'FEED_FORMAT':'json',
        'FEED_URI':'/home/juan/trustpilot_hp.json',
