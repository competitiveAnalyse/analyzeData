...
class TrustpilotMsiSpider(scrapy.Spider):
    name = 'trustpilot_razer'
    allowed_domains = ['trustpilot.com/review/razer.com?languages=en']
    start_urls = ['https://www.trustpilot.com/review/razer.com?languages=en']
    custom_settings = {
        'FEED_FORMAT':'json',
        'FEED_URI':'/home/juan/trustpilot_razer.json',
...
#                dont_filter= True)
        ...
        data_type = response.css(".multi-size-header__small::text").extract()
