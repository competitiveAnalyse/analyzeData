...
class TrustpilotMsiSpider(scrapy.Spider):
    name = 'trustpilot_asus'
    allowed_domains = ['trustpilot.com/review/www.asus-uk.com?languages=en',
                       'trustpilot.com/review/www.asus.com?languages=en']
    start_urls = ['https://www.trustpilot.com/review/www.asus-uk.com?languages=en',
                  'https://www.trustpilot.com/review/www.asus.com?languages=en']
    custom_settings = {
        'FEED_FORMAT':'json',
        'FEED_URI':'/home/juan/trustpilot_asus.json',
