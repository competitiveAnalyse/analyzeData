...
class TrustpilotMsiSpider(scrapy.Spider):
    name = 'trustpilot_alienware'
    allowed_domains = ['trustpilot.com/review/www.alienware.co.uk?languages=en',
                       'trustpilot.com/review/www.alienware.com?languages=en']
    start_urls = ['https://www.trustpilot.com/review/www.alienware.co.uk?languages=en',
                  'https://www.trustpilot.com/review/www.alienware.com?languages=en']
    custom_settings = {
        'FEED_FORMAT':'json',
        'FEED_URI':'/home/juan/trustpilot_alienware.json',
